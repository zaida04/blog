...
I spent months building Yoki in the shadows, and in that time I was able to bring onboard my wonderful partners IDKGoodName and ItzNxthaniel.
...
The continuing problem regarding slow API features and bug fixes were one thing (which was never solved either), but this was a complete disregard for the community that had been built up over the years.
...
This followed in solidary with a lot of the other moderation bots on the platform, like [Parrot](https://parrotbot.gg/), [Server Guard](https://www.guilded.gg/server-guard), and [EcoNuker](https://www.guilded.gg/econuker). Many other bots followed suit.
